...
/// @notice A simple flawed DAO voting mechanism with token-based voting
contract SingleVoteFlawDAO {
    ...
    // Flawed logic in not checking if the user has voted
    function vote(uint256 _proposalId, bool _support) onlyTokenHolder {
